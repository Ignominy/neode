...
function MergeOn(neode, model, merge_on, properties, extraEagerNames, customerId) {
  return (0, _GenerateDefaultValues["default"])(neode, model, properties).then(function (properties) {
    ...
    (0, _WriteUtils.addNodeToStatement)(neode, builder, alias, model, properties, [alias], "merge", merge_on, customerId); // Output
