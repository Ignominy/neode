...
var Builder = /*#__PURE__*/function () {
  ...
  _createClass(Builder, [{
    ...
    key: "optionalMatch",
    value: function optionalMatch(alias, model, customerId) {
      this.whereStatement("WHERE");
      this.statement("OPTIONAL MATCH");
      this._current.match(new _Match["default"](alias, model, undefined, customerId));
      return this;
    }
    ...
    value: function create(alias, model, properties, customerId) {
      ...
      this._current.match(new _Match["default"](alias, model, this._convertPropertyMap(alias, properties, iu), customerId));
      return this;
    }
