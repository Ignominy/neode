...
var Factory = /*#__PURE__*/function () {
  ...
  _createClass(Factory, [{
    ...
    value: function hydrateNode(record, definition, extraEagerNames) {
      ...
      var node = new _Node["default"](this._neode, definition, identity, labels, properties); // Create an array of all eagers and extra eagers
    ...
    value: function hydrateRelationship(definition, record, this_node, extraEagerNames) {
      ...
      var other_node = this.hydrateNode(record[definition.nodeAlias()], undefined, extraEagerNames); // Calculate Start & End Nodes
