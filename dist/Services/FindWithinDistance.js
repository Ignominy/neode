...
function FindWithinDistance(neode, model, location_property, point, distance, properties, extraEagerNames, order, limit, skip, customerId) {
  var alias = "this";
  var builder = new _Builder["default"](neode); // Match

  builder.match(alias, model, undefined, customerId); // Where
  ...
  var output = (0, _EagerUtils.eagerNode)(neode, 1, alias, model, extraEagerNames, customerId); // Complete Query
