...
function First(neode, model, properties, extraEagerNames, customerId) {
  return (0, _Validator["default"])(neode, model, properties, true).then(function (properties) {
    var alias = _ReadUtils.ORIGINAL_ALIAS;
    var builder = new _Builder["default"](neode);
    (0, _ReadUtils.addReadNodeToStatement)(neode, builder, alias, model, properties, undefined, [alias], customerId); // Output
