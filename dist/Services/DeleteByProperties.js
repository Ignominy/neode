...
function addCascadeDeleteNode(neode, builder, from_alias, relationship, aliases, curr_depth, to_depth, customerId) {
  ...
  // Optional Match
  builder.optionalMatch(from_alias).relationship(relationship.relationship(), relationship.direction(), rel_alias).to(node_alias, relationship.target(), undefined, customerId);
...
function DeleteByProperties(neode, model, properties, customerId) {
  ...
  (0, _ReadUtils.addReadNodeToStatement)(neode, builder, alias, model, properties, undefined, aliases, customerId);
